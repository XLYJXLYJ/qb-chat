<!DOCTYPE html><html><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1,user-scalable=0"><title>{{$title or '智能风险官Aimi'}}</title><link href=/statics/css/app.860809bc4ee7b52e0f220de48f696e2e.css rel=stylesheet></head><body><div id=app-box></div><script type=text/javascript src=/statics/js/manifest.5ac2fa1bb7c0a2ed81e6.js></script><script type=text/javascript src=/statics/js/vendor.b296cf762bf6ed6bc6fe.js></script><script type=text/javascript src=/statics/js/app.4877ff76cf3cbaecf9a5.js></script></body><script src=/statics/js/RongIMLib.js></script><script src=/statics/js/exif.js></script><script src=http://static.qibaozz.com/crypto/aes.js></script></html><script>//测试数据
